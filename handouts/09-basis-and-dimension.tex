...
On Friday, we saw a proof of the Steinitz Exchange Lemma, a key result
in understanding the relationship between linearly independent sets
and spanning sets.  Earlier last week we saw some examples of
...
the first week, e.g., row reduction.
