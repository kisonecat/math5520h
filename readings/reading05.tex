...
Eigenvectors and eigenvalues are important topics, so we'll be taking
it a bit slower; next week we will be considering ``generalized
eigenvectors'' and we will have a chance to revisit this week's
material in depth.

There is also the first midterm this week, so I expect you will be
preparing for that.
...
To consider ``eigenstuff'' for an operator
