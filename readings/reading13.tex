...
Unwrapping this will lead us to consider again the \textbf{Schur
  decomposition}.  Recall that, instead of
thinking about orthogonal complements (which is one way to
tackle the Schur decomposition!), we can also discover the Schur decomposition
via \textbf{quotient spaces}.
